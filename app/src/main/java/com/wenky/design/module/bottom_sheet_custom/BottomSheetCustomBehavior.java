 ...
 */
public class BottomSheetCustomBehavior<V extends ViewGroup> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class ScrollLayoutCallback {
        ...
        public abstract void onSlide(@NonNull ViewGroup viewGroup, BottomSheetCustomBehavior behavior, int position);
    }
    ...
    public BottomSheetCustomBehavior() {
    }

    public BottomSheetCustomBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs,
                R.styleable.BottomSheetCustomBehavior);
        mHalfExpandedSpace = ta.getDimensionPixelSize(
                R.styleable.BottomSheetCustomBehavior_behavior_half_expanded_space, 0);
        mFullExpandedSpace = ta.getDimensionPixelSize(
                R.styleable.BottomSheetCustomBehavior_behavior_full_expanded_space, 0);
        mBelowToId = ta.getResourceId(R.styleable.BottomSheetCustomBehavior_behavior_below_to, View.NO_ID);
        ta.recycle();
    ...
    public static <V extends ViewGroup> BottomSheetCustomBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomSheetCustomBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetCustomBehavior");
        }
        return (BottomSheetCustomBehavior<V>) behavior;
    }
}
