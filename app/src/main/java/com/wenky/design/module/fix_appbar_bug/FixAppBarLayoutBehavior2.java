...
public class FixAppBarLayoutBehavior2 extends AppBarLayout.Behavior {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, AppBarLayout child, MotionEvent ev) {
        LogHelper.d(TAG, "onInterceptTouchEvent:" + child.getTotalScrollRange());
    ...
    private void stopAppbarLayoutFling(AppBarLayout appBarLayout) {
        ...
        try {
            ...
            if (flingRunnable != null) {
                LogHelper.d(TAG, "存在flingRunnable");
    ...
    public boolean onStartNestedScroll(CoordinatorLayout parent, AppBarLayout child, View directTargetChild, View target, int nestedScrollAxes, int type) {
        LogHelper.d(TAG, "onStartNestedScroll");
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target, int dx, int dy, int[] consumed, int type) {
        LogHelper.d(TAG, "onNestedPreScroll:" + child.getTotalScrollRange() + " ,dx:" + dx + " ,dy:" + dy + " ,type:" + type);
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child, View target, int dxConsumed, int dyConsumed, int
        ...
        LogHelper.d(TAG, "onNestedScroll: target:" + target.getClass() + " ," + child.getTotalScrollRange() + " ,dxConsumed:" + dxConsumed + " ,dyConsumed:" + dyConsumed + " " + ",type:" + type);
        if (!shouldBlockNestedScroll) {
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout abl, View target, int type) {
        LogHelper.d(TAG, "onStopNestedScroll");
