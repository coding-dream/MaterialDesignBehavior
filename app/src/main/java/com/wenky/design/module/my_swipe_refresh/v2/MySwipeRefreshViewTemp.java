...
public class MySwipeRefreshViewTemp extends ViewGroup implements NestedScrollingParent
    ...
    /**
     * Classes that wish to override {@link MySwipeRefreshViewTemp#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link MySwipeRefreshViewTemp#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(MySwipeRefreshViewTemp parent, @Nullable View child);
    }
}